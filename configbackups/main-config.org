...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package gptel
    ...
    (define-key my/gptel-map (kbd "1")   #'my/gptel-use-haiku)
    (define-key my/gptel-map (kbd "2")   #'my/gptel-use-sonnet)
    (define-key my/gptel-map (kbd "3")   #'my/gptel-use-opus)
