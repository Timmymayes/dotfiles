...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my/elfeed-filter-youtube ()
    (interactive)
    (elfeed-search-set-filter "@1-month-ago +youtube"))
  ...
  (defun my/elfeed-next-and-load-mpv ()
    (interactive)
    (elfeed-show-next)
  ...
  (define-key elfeed-show-mode-map (kbd "n") #'my/elfeed-next-and-load-mpv)


#+END_SRC

#+RESULTS:
: my/elfeed-next-and-load-mpv
